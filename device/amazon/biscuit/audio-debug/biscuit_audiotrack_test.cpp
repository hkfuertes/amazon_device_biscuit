...
int main(int argc, char **argv)
{
    ...
    sp<AudioTrack> track = new AudioTrack(AUDIO_STREAM_MUSIC, rate, AUDIO_FORMAT_PCM_16_BIT,
    ...
    fflush(stdout);
    _exit(0); /* ponytail: AudioTrack destructor crashes in this shell test; kernel/HAL path already validated. */
}
